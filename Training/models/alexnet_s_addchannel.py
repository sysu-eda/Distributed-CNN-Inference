...
class AlexNet_S_Addchannel(nn.Module):
    def __init__(self, num_classes=1000, num_group=4):
        super(AlexNet_S_Addchannel, self).__init__()
...
def alexnet_s_addchannel(pretrained=False, **kwargs):
    """
    ...
    """
    model = AlexNet_S_Addchannel(**kwargs)
    if pretrained:
