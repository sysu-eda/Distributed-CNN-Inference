...
class ResNet_Block_S_AddChannel(nn.Module):

    def __init__(self, block, layers, num_classes=1000):
        super(ResNet_Block_S_AddChannel, self).__init__()
...
def resnet50_block_s_addchannel(pretrained=False, **kwargs):
    """Constructs a ResNet-50 model.

    Args:
        pretrained (bool): If True, returns a model pre-trained on ImageNet
    """
    model = ResNet_Block_S_AddChannel(Bottleneck, [3, 4, 6, 3], **kwargs)
    if pretrained:
