...
class VGG(nn.Module):
    ...
    def __init__(self, num_classes=1000, init_weights=True):
        ...
        self.block0 = nn.Sequential(
            ...
            nn.Conv2d(96, 96, kernel_size=3, padding=1, groups=4),
            nn.BatchNorm2d(96), 
            nn.ReLU(inplace=True),
            
            nn.MaxPool2d(kernel_size=2, stride=2),
            
            nn.Conv2d(96, 192, kernel_size=3, padding=1, groups=4),
            nn.BatchNorm2d(192), 
            nn.ReLU(inplace=True),
            
            nn.Conv2d(192, 192, kernel_size=3, padding=1, groups=4),
            nn.BatchNorm2d(192), 
            nn.ReLU(inplace=True),
            
            nn.MaxPool2d(kernel_size=2, stride=2),
            
            nn.Conv2d(192, 384, kernel_size=3, padding=1, groups=4),
            nn.BatchNorm2d(384), 
            nn.ReLU(inplace=True)
        )
            
        self.block1 = nn.Sequential(
            nn.Conv2d(384, 384, kernel_size=3, padding=1, groups=4),
            nn.BatchNorm2d(384), 
            nn.ReLU(inplace=True),
            ...
            nn.Conv2d(384, 768, kernel_size=3, padding=1, groups=4),
            nn.BatchNorm2d(768), 
            nn.ReLU(inplace=True),
            
            nn.Conv2d(768, 768, kernel_size=3, padding=1, groups=4),
            nn.BatchNorm2d(768), 
            nn.ReLU(inplace=True)
...
def vgg16_bn_s3_addchannel(pretrained=False, **kwargs):
